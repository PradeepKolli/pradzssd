...
public class LzoSampleDriverDecrypt extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(LzoSampleDriverDecrypt.class);
	...
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new LzoSampleDriverDecrypt(), args);
